...
function getEndpoints(deviceAddress, endpoints) {
  ...
  var e = endpoints.addEndpoint("1", "Channel 1", endpointType.genericSensor);
  e.variableTypeId = 1409;
  var e = endpoints.addEndpoint("2", "Channel 2", endpointType.genericSensor);
  e.variableTypeId = 1409;
  var e = endpoints.addEndpoint("3", "Channel 3", endpointType.genericSensor);
  e.variableTypeId = 1409;
  var e = endpoints.addEndpoint("4", "Channel 4", endpointType.genericSensor);
  e.variableTypeId = 1409;
  var e = endpoints.addEndpoint("5", "Channel 5", endpointType.genericSensor);
  e.variableTypeId = 1409;
  var e = endpoints.addEndpoint("6", "Channel 6", endpointType.genericSensor);
  e.variableTypeId = 1409;
}
