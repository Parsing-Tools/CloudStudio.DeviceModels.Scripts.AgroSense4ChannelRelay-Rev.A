...
# Parsing + Configuration Script – AgroSense 4 Channel Relay - Rev. A

This **Parsing + Configuration** script is designed for the **AgroSense 4 Channel Relay** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – AgroSense 4 Channel Relay Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **AgroSense 4 Channel Relay** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
